...
export const entries: CodexEntry[] = [
  ...
  },
  {
    ...
    summary: 'Гордый уроженец Бретоннии, воспитанный на идеалах рыцарства, чести и служения сюзерену. Бретонцы ценят доблесть в бою и верность клятвам, а простолюдины трудятся на землях своих лордов.',
